...
if(INTERN_BUILD_ATEN_OPS)
  ...
  elseif(CXX_SVE_128_FOUND)
    ...
    if("${CMAKE_C_COMPILER_ID}" MATCHES "Clang")
        list(APPEND CPU_CAPABILITY_FLAGS "${OPT_FLAG} -O2 -march=armv8.4-a+sve2+fp16+fp16fml+bf16 -D__ARM_FEATURE_BF16 -DCPU_CAPABILITY_SVE -DCPU_CAPABILITY_SVE128 -msve-vector-bits=128")
    else()
        list(APPEND CPU_CAPABILITY_FLAGS "${OPT_FLAG} -march=armv8.4-a+sve2+fp16+fp16fml+bf16 -D__ARM_FEATURE_BF16 -DCPU_CAPABILITY_SVE -DCPU_CAPABILITY_SVE128 -msve-vector-bits=128")
    endif()
